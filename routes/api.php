...
Route::put('soal_iks_up/{id}', 'Soal_iksController@update');
...
Route::put('jawaban_iks_up/{id}', 'Jawaban_iksController@update');
...
Route::put('pelayanan/{id}', 'PelayananController@update');
...
Route::put('order_pelayanan/{id}', 'Order_pelayananController@update');
...
Route::put('order_konsultasi/{id}', 'Order_konsultasiController@update');
...
Route::put('keterangan/{id}', 'keterangan_iksController@update');
...
Route::put('intervensi/{id}', 'IntervensiController@update');
...
Route::put('iks/{id}', 'IksController@update');
